...
output_migration_path = r"e:\PROJECTS\mazhavilcostumes\database\migrations\028_import_products_part1.sql"
...
with open(csv_file_path, mode='r', encoding='utf-8') as f:
    ...
    # The first line of the CSV is "Products,Products,Products,,,,Products"
    # The second line is the header: "Name,Description,Category,GST,Rent,Purchase Price,Qty"
    line = f.readline()
...
# Add products
for idx, row in enumerate(first_500_rows, 1):
    ...
    # Name is the code (e.g. TOP-83) and is also the barcode
    name_escaped = name_code.replace("'", "''")
    barcode_escaped = name_code.replace("'", "''")
    
    # Description is used as description + SKU
...
print("Successfully wrote migration Part 1!")

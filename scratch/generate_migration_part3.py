...
output_migration_path = r"e:\PROJECTS\mazhavilcostumes\database\migrations\030_import_products_part3.sql"
...
# Get next 500 rows (from 1000 to 1499 inclusive)
part3_rows = rows[1000:1500]

print(f"Total rows parsed: {len(rows)}")
print(f"Part 3 rows count: {len(part3_rows)}")
print(f"First product in Part 3: {part3_rows[0]['name_code']} ({part3_rows[0]['description']})")
print(f"Last product in Part 3: {part3_rows[-1]['name_code']} ({part3_rows[-1]['description']})")
...
# Add products
for idx, row in enumerate(part3_rows, 1001):
...
print("Successfully wrote migration Part 3!")

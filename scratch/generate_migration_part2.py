...
output_migration_path = r"e:\PROJECTS\mazhavilcostumes\database\migrations\029_import_products_part2.sql"
...
# Get next 500 rows (from 500 to 999 inclusive)
next_500_rows = rows[500:1000]

print(f"Total rows parsed: {len(rows)}")
print(f"Next 500 rows count: {len(next_500_rows)}")
print(f"First product in Part 2: {next_500_rows[0]['name_code']} ({next_500_rows[0]['description']})")
print(f"Last product in Part 2: {next_500_rows[-1]['name_code']} ({next_500_rows[-1]['description']})")
...
# Add products
for idx, row in enumerate(next_500_rows, 501):
...
print("Successfully wrote migration Part 2!")

-- ============================================================================
-- Migration 021: Update RPC Function for Late Flag
-- Updates get_operational_dashboard_metrics to use is_late flag instead of late_return status
-- ============================================================================
...
BEGIN
  ...
  -- 2.8 Pending Return (overdue) - updated to use is_late flag
  ...
  -- 2.9 Revenue Due - removed late_return status

-- ============================================================================
-- Migration 022: Force Update RPC Function for Late Flag
-- This migration ensures get_operational_dashboard_metrics has no late_return references
-- Run this if migration 021 didn't fully update the function
-- ============================================================================
...
BEGIN
  ...
  -- 2.3 Today's Delivery Done (removed late_return)
  ...
  -- 2.8 Pending Return (overdue) - removed late_return, using is_late flag logic
  ...
  -- 2.9 Revenue Due - removed late_return
